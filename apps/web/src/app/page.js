...
const actions = [
  {
    ...
    text: "Call your bank, report fraud, or find support nearby.",
    route: "/help",
    tone: "urgent",
    icon: "!",
  },
  {
    ...
    text: "Learn the warning signs before you reply, click, or pay.",
    route: "/library",
    tone: "primary",
    icon: "?",
  },
  {
    title: "Report a scam",
    text: "Share what happened and help others spot the same trick.",
    route: "/postReport",
    tone: "neutral",
    icon: "+",
  },
    ...
    <main className="home-page">
      <section className="hero-section">
        ...
        <p className="hero-copy">
          CyberSafe gives you clear next steps when something online does not
          feel right.
        </p>
      </section>
      ...
      <section className="safety-banner" aria-label="Immediate safety guidance">
        ...
        <span>
          Call your bank immediately. Do not share a PIN, password, or OTP.
        </span>
      </section>
      ...
      <section className="action-list" aria-label="Choose an action">
        {actions.map((action) => (
          <button
            className={`action-card action-${action.tone}`}
            key={action.title}
      ...
      <section className="tip-card">
        ...
        <p>
          Real banks will not ask you to share your one-time password by phone,
          SMS, or WhatsApp.
        </p>
      </section>

      <p className="disclaimer">
        CyberSafe is for awareness and guidance, not emergency protection. Use a
        safe, private device where possible.
      </p>
